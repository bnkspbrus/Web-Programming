...
public class FrontServlet extends HttpServlet {
    ...
    public void init() throws ServletException {
        sourceFreemarkerConfiguration = newFreemarkerConfiguration(
                getServletContext().getRealPath(".") + "/../../src/main/webapp/WEB-INF/templates", true);
        targetFreemarkerConfiguration = newFreemarkerConfiguration(getServletContext().getRealPath("WEB-INF/templates"),
                false);
    }
    ...
    Method findMethod(Class<?> pageClass, String name, Class<?>... args) {
        Method method = null;
    ...
    private void process(Route route, HttpServletRequest request,
        ...
        Method methodBefore = findMethod(pageClass, "before", HttpServletRequest.class, Map.class);
...
//            throw new ServletException("Unable to run action [pageClass=" + pageClass + ", method=" + methodBefore + "].", e);
//        }
        ...
        try {
            ...
            if (cause instanceof RedirectException) {
                ...
                throw new ServletException("Unable to run action [pageClass=" + pageClass + ", method=" + method + "].",
                        e);
            }
        }

        Method methodAfter = findMethod(pageClass, "after", HttpServletRequest.class, Map.class);
        ...
        try {
            ...
            throw new ServletException("Unable to run action [pageClass=" + pageClass + ", method=" + methodAfter + "].", e);
        }
        ...
        try {
            ...
            throw new ServletException("Can't render template [pageClass=" + pageClass + ", method=" + method + "].",
                    e);
        }
    }
