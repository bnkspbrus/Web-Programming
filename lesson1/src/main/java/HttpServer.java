...
class HttpServer {
    ...
    private void process(Request request, Response response) throws IOException {
        ...
        String newEtag = getNewEtag(file);
        if (request.headers.containsKey("If-None-Match")) {
            if (request.getHeader("If-None-Match").equals(newEtag)) {
    ...
    private String getNewEtag(File file) throws IOException {
//        BasicFileAttributes bfa = Files.readAttributes(file.toPath(), BasicFileAttributes.class);
    ...
    private static final class Request {
        ...
        private Request(String request) throws UnsupportedEncodingException {
            ...
            uri = URLDecoder.decode(firstLineTokens[1], StandardCharsets.UTF_8.toString()); //path
            headers = new HashMap<>();
