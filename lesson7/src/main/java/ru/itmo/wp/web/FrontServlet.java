...
public class FrontServlet extends HttpServlet {
    ...
    private void process(Route route, HttpServletRequest request,
        ...
        boolean json = method.getAnnotation(
                Json.class) != null || (acceptRequestHeader != null && acceptRequestHeader.startsWith(
        ...
        if (json) {
            ...
            try {
                ...
                throw new ServletException(
                        "Can't render template [pageClass=" + pageClass + ", method=" + method + "].", e);
            }
        }
    }
    ...
    private static final class Route {
        ...
        private static Route newIndexRoute(HttpServletRequest request) {
            return new Route(IndexPage.class.getName(),
                    request.getParameter("action") == null ? DEFAULT_ACTION : request.getParameter("action"));
        }
